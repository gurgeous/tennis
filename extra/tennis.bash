...
_tennis() {
  ...
  if [[ "${cur}" == -* ]]; then
    COMPREPLY=($(compgen -W "-n --row-numbers -t --title --border --peek --zebra --deselect --select --sort -r --reverse --shuffle --shuf --head --tail --filter --table --color --delimiter --digits -p --pager --theme --vanilla --width --completion --help --version " -- "${cur}"))
  else
    _filedir csv
